...
namespace SmartWorking.Office.Entities
{
  public static class SelfTrackingEntitiesContextExtensions
  {
      ...
      where TEntity : class, IObjectWithChangeTracker
    {
      ...
      objectSet.Context.ApplyChanges(objectSet.EntitySet.EntityContainer.Name + "." + objectSet.EntitySet.Name, entity);
    }
      ...
      where TEntity : IObjectWithChangeTracker
    {
      ...
      try
      {
        ...
        var allRelationships = new RelationshipSet(context, entityIndex.AllEntities);
        ...
        foreach (IObjectWithChangeTracker changedEntity in entityIndex.AllEntities)
        {
          ...
          foreach (NavigationProperty navProp in entityType.NavigationProperties)
          {
            ...
            {
              ApplyChangesToIndependentAssociation(context, changedEntity, entry, navProp, relatedEnd, allRelationships);
            }
          }
        }
        ...
        foreach (RelationshipWrapper relationship in allRelationships)
        {
                                                             ...
                                                             IRelatedEnd relatedEnd, RelationshipSet allRelationships)
    {
      ...
      else
      {
        if (navProp.ToEndMember.RelationshipMultiplicity == RelationshipMultiplicity.Many)
        {
          ...
          {
            foreach (object removedEntityFromAssociation in collectionPropertyChanges)
            {
          ...
          {
            foreach (object addedEntityFromAssociation in collectionPropertyChanges)
            {
              ObjectStateEntry addedRelationshipEntry =
                context.ObjectStateManager.ChangeRelationshipState(
                  changedEntity,
                                               ...
                                               RelationshipSet allRelationships, IObjectWithChangeTracker entity)
    {
          ...
          changeTracker.State == ObjectState.Deleted)
      {
        ...
        {
          var associationSet = ((AssociationSet) entityReference.RelationshipSet);
          ...
          if (currentKey != null)
          {
                ...
                currentEntry.State == EntityState.Deleted)
            {
              ...
              MoveSavedReferenceKey(entityReference, entity, navigationProperty, changeTracker.ExtendedProperties,
                                    changeTracker.OriginalValues);
          ...
          if (originalKey != null)
          {
            ...
            else
            {
                    ...
                    RelationshipMultiplicity != RelationshipMultiplicity.Many)
              {
                targetReference =
                  originalEntry.RelationshipManager.GetRelatedEnd(entityReference.RelationshipName,
                                                                  entityReference.SourceRoleName) as EntityReference;
              ...
              deletedRelationshipEntry = CreateRelationship(context, entityReference, entry.EntityKey, originalKey,
                                                            EntityState.Deleted);
    ...
    {
      Debug.Assert(
        navigationProperty == null || reference.RelationshipSet.ElementType == navigationProperty.RelationshipType,
      ...
      var foundKeyMembers = new List<EntityKeyMember>(1);
      bool foundNone = true;
    ...
    internal static void StoreReferenceKeyValues(this ObjectContext context, IObjectWithChangeTracker entity)
    {
      ...
      RelationshipManager relationshipManager = entry.RelationshipManager;
      EntityType entityType = context.MetadataWorkspace.GetCSpaceEntityType(entity);
      foreach (EntityReference entityReference in EnumerateSaveReferences(relationshipManager))
      {
        NavigationProperty navigationProperty =
        ...
        {
          foreach (EntityKeyMember item in entityReference.EntityKey.EntityKeyValues)
          {
                                               ...
                                               AssociationEndMember toEnd, out ObjectStateEntry entry)
    {
      entry = null;
      foreach (
        ObjectStateEntry relationshipEntry in
          (from e in context.ObjectStateManager.GetObjectStateEntries(EntityState.Added | EntityState.Unchanged)
    ...
    private sealed class AddHelper
    {
      ...
      public static EntityIndex AddAllEntities(ObjectContext context, string entitySetName,
                                               IObjectWithChangeTracker entity)
      {
        var addHelper = new AddHelper(context);
      ...
      private void HandleStateManagerChange(object sender, CollectionChangeEventArgs args)
      {
        ...
        {
          var entity = args.Element as IObjectWithChangeTracker;
          ...
          foreach (var collectionPropertyChangesWithName in changeTracker.ObjectsRemovedFromCollectionProperties)
          {
            _entitiesDuringAdd.Enqueue(new Tuple<ObjectStateEntry, string, IEnumerable<object>>(
                                         entry,
      ...
      private void ProcessNewAdds()
      {
        while (_entitiesDuringAdd.Count > 0)
        {
          ...
          foreach (object targetEntity in relatedEntities.Item3)
          {
    ...
    private sealed class RelationshipSet : IEnumerable<RelationshipWrapper>
    {
      ...
      public void Remove(ObjectStateEntry relationshipEntry)
      {
        ...
        var associationSet = (AssociationSet) relationshipEntry.EntitySet;
