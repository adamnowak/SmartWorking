  ...
  public class DocumentPaginatorWrapper : DocumentPaginator
  {
    ...
    public override DocumentPage GetPage(int pageNumber)
    {
      ...
      using (DrawingContext ctx = title.RenderOpen())
      {
        ...
        FormattedText printingDate = new FormattedText("Wydrukowano: " + DateTime.Now, //.ToShortDateString(),
                                               System.Globalization.CultureInfo.CurrentCulture, FlowDirection.LeftToRight,
                                               m_Typeface, 14, Brushes.Black);

        ctx.DrawText(printingDate, new Point(0, -96 / 4)); // 1/4 inch above page content

        FormattedText pageNo = new FormattedText("Page " + (pageNumber + 1),
                                               System.Globalization.CultureInfo.CurrentCulture, FlowDirection.LeftToRight,
                                               m_Typeface, 14, Brushes.Black);

        ctx.DrawText(pageNo, new Point(PageSize.Width - 100, -96 / 4)); // 1/4 inch above page content
      }
    ...
    public override Size PageSize
    {
      ...
      set
      {
        ...
        m_Paginator.PageSize = new Size(m_PageSize.Width - m_Margin.Width * 2,
                                        m_PageSize.Height - m_Margin.Height * 2);
      }
    }
