USE [SmartWorking]
GO
/****** Object:  Table [dbo].[Recipes]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Contractors]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Clients]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Cars]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Buildings]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Materials]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Drivers]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[RecipeComponents]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MaterialStocks]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[DeliveryNotes]    Script Date: 07/06/2012 21:43:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  ForeignKey [FK_Buildings_Clients]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_DeliveryNotes_Cars]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_DeliveryNotes_Drivers]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_DeliveryNotes_Orders]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_Drivers_Cars]    Script Date: 07/06/2012 21:43:31 ******/
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Drivers_Cars]') AND parent_object_id = OBJECT_ID(N'[dbo].[Drivers]'))
ALTER TABLE [dbo].[Drivers]  WITH CHECK ADD  CONSTRAINT [FK_Drivers_Cars] FOREIGN KEY([Car_Id])
REFERENCES [dbo].[Cars] ([Id])
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Drivers_Cars]') AND parent_object_id = OBJECT_ID(N'[dbo].[Drivers]'))
ALTER TABLE [dbo].[Drivers] CHECK CONSTRAINT [FK_Drivers_Cars]
GO
/****** Object:  ForeignKey [FK_MaterialsDeliverer_Contractors]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_MaterialsProducer_Contractors]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_MaterialStocks_Materails]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_Orders_Buildings]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_Orders_Recipes]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_RecipeComponents_Materials]    Script Date: 07/06/2012 21:43:31 ******/
...
GO
/****** Object:  ForeignKey [FK_RecipeComponents_Recipes]    Script Date: 07/06/2012 21:43:31 ******/
